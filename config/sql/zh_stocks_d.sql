...
CREATE TABLE `zh_stocks_d` (
  ...
  `sw_ind1` varchar(255) DEFAULT NULL COMMENT '申万一级行业',
  `sw_ind1_weight` decimal(20,3) DEFAULT NULL COMMENT '申万一级行业权重',
  `area` varchar(255)  DEFAULT NULL COMMENT '地区',
  `market` varchar(255)  DEFAULT NULL COMMENT '市场',
  ...
  `is_gap` varchar(10)  DEFAULT NULL COMMENT '是否有缺口',
  ...
  `is_esm_over` varchar(10) DEFAULT NULL COMMENT '是否交叉(EMA20上穿EMA60)',
  `eml` decimal(20,3) DEFAULT NULL COMMENT 'EMA M/L',
  `peml` decimal(20,3) DEFAULT NULL COMMENT '前一日 EMA M/L',
  `is_eml_over` varchar(10)  DEFAULT NULL COMMENT '是否交叉(EMA60上穿EMA120)',
